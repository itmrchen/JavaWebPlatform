...
import com.javazx.dao.SysMenuDao;
...
public class SysMenuService<T> extends BaseService<T> {
    ...
    public void addNew(SysMenu menu) throws Exception {
        super.add((T) menu);
        saveBtns(menu.getId(), menu.getBtns());
    }


    public void updateNew(SysMenu menu) throws Exception {
        super.update((T) menu);
        saveBtns(menu.getId(), menu.getBtns());
    }
