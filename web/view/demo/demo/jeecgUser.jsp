     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
					...
					<div class="fitem">
						<label>住址</label>
						<input name="adress" type="text" maxlength="255" class="easyui-validatebox" data-options="required:true" missingMessage="请填写住址">
					</div>
					<div class="fitem">
						<label>工资</label>
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/demo/demo/page-jeecgUser.js"></script>
  </body>
</html>
